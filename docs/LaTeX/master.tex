...
\begin{figure}[H]
  \centering
  \subfigure[Start with a blank board]{
  \includegraphics[width=0.45\textwidth]{images/step1.jpg}
  }
  \subfigure[Get a regular PNP transistor, see suggestions above]{
  \includegraphics[width=0.45\textwidth]{images/step2.jpg}
  }
  \subfigure[Cut a VDD trace to supply the FT232 from USB power]{
  \includegraphics[width=0.45\textwidth]{images/step4.png}
  }
  \subfigure[Cut another VDD track]{
  \includegraphics[width=0.45\textwidth]{images/step5.png}
  }
...
\begin{figure}[H]
  \centering
  \subfigure[Separate this via from the ground plane to enable the LEDs]{
  \includegraphics[width=0.45\textwidth]{images/step6.png}
  }
  \subfigure[Prepare components for assembly]{
  \includegraphics[width=0.45\textwidth]{images/step7.jpg}
  }
  \subfigure[Assemble them (oven, rework station, iron, etc)]{
  \includegraphics[width=0.45\textwidth]{images/step8.jpg}
  }
  \subfigure[SMD components assembled]{
  \includegraphics[width=0.45\textwidth]{images/step9.jpg}
  }
...
\begin{figure}[H]
  \centering
  \subfigure[Transistor soldered using 2 convenient vias]{
  \includegraphics[width=0.45\textwidth]{images/step10.jpg}
  }
  \subfigure[Join 5v from the USB to: the right of the .1uF cap.]{
  \includegraphics[width=0.45\textwidth]{images/step11.jpg}
  }
  \subfigure[See the text to know the transistor connections]{
  \includegraphics[width=0.45\textwidth]{images/step12.jpg}
  }
  \subfigure[Route another 5v wire to the via previously detached from the ground plane, in orden to activate the LEDs ]{
  \includegraphics[width=0.45\textwidth]{images/step13.png}
  }
...
\begin{figure}[H]
  \centering
  \subfigure[Modification finished]{
  \includegraphics[width=0.45\textwidth]{images/step14.png}
  }
  \subfigure[Modification finished]{
  \includegraphics[width=0.45\textwidth]{images/step15.png}
  }
  \subfigure[Schematic reference]{
  \includegraphics[width=0.85\textwidth]{images/FT232_sch.png}
  }
  \caption{USB modifications}
\end{figure}
...
\begin{figure}[htb]
  \centering
  \subfigure[Injector driver mod top]{
  \includegraphics[width=0.45\textwidth]{images/injector_hack_front.jpeg}
  }
  \subfigure[Injector driver mod bottom]{
  \includegraphics[width=0.45\textwidth]{images/injector_hack_back.png}
  }
