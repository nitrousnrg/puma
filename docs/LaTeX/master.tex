...
\begin{center}
\includegraphics[width = 0.4\textwidth]{images/MCU_VDD_traces.png}
\includegraphics[width = 0.4\textwidth]{images/BRV_hack.png}

\includegraphics[width = 0.4\textwidth]{images/USB_power_hack.png}
\includegraphics[width = 0.4\textwidth]{images/P&H_hack.png}
\end{center}
