...
Modify the board as shown in ``Spin 1 specific notes"
...
\item Open Codewarrior's debugger, the BDM pod should perform some recognition tasks
\item In the debugger, go to File->Load Application and select the .s19 binary.
\item Program the device. Verification should be successful.
\item Poweroff the board, disconnect the USB, disconnect the pod
\end{enumerate}
